...
import static org.redhat.services.test.util.TestWorkflowConstant.getActiveTaskStatuses;
...
public abstract class KieTestUtilsIT {
    ...
    protected TaskSummary assertTaskInstance(Long processInstanceId, int expectedTaskCount, String taskOwner, String taskName) {
        ...
        List<TaskSummary> tasks = userTaskServicesClient.findTasksByStatusByProcessInstanceId(processInstanceId, getActiveTaskStatuses(), 0, 100);
        assertNotNull(tasks);
